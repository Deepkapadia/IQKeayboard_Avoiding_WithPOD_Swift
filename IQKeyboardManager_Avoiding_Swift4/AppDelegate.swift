//
//  AppDelegate.swift
//  IQKeyboardManager_Avoiding_Swift4
//
//  Created by DeEp KapaDia on 20/06/18.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        //----- To Hide Tool Bat Buttons and all ----
        manager.enableAutoToolbar = false
        
        //----- for Touch outside and hide keybpad apears ------
        manager.shouldResignOnTouchOutside = true
        
        //----- Disable Click Sound------
        manager.shouldPlayInputClicks = false
        
        //---- Spacing between keyboard and textfields -----
